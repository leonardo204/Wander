...
- **버전**: v2.0
- **작성일**: 2026년 1월 30일
- **기반 문서**: wander_planning_report.md v2.0
- **목적**: 개발자가 구현 시 참고할 수 있는 상세 UI 시나리오 및 예외 케이스 정의
- **주요 변경**: 서버리스 전환, 프리미엄/로그인 제거, BYOK 기본 기능화, 탭바 3개로 통일
...
flowchart TD
    subgraph "홈 화면 액션"
        ...
        A -->|여행 기록 만들기 탭| B[사진 선택 화면]
        A -->|지금 뭐해? 탭| C[퀵모드 사진 선택]
        A -->|이번 주 하이라이트 탭| D[주간 사진 자동 수집]
...
*문서 버전: v1.1*
*최종 수정: 2026년 1월 30일*
*변경사항: 공유 텍스트 출처 표기 기능 추가 (8.3 섹션)*
*다음 단계: 프로토타입 제작 (Figma)*
